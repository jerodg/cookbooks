...
.For Ubuntu/Debian
[source,sh,linenums]
sudo apt-get -y install build-essential python-dev python-setuptools python-pip libncursesw5-dev libgdbm-dev libc6-dev zlib1g-dev python-smbus libssl-dev openssl libffi-dev libsqlite3-dev
