...
openssl libffi-dev libsqlite3-dev
...
.ubuntu 16.10+
[source,sh,linenums]
sudo apt install build-essential libncursesw5-dev libssl-dev libgdbm-dev libc6-dev libsqlite3-dev libbz2-dev liblzma-dev libreadline-gplv2-dev libdb-dev binutils binfmt-support
cd /var/tmp
